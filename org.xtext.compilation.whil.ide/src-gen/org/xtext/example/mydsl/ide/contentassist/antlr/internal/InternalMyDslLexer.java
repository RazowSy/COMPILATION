...
public class InternalMyDslLexer extends Lexer {
    ...
    public final void mT__24() throws RecognitionException {
        try {
            int _type = T__24;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:20:7: ( 'fi' )
            // InternalMyDsl.g:20:9: 'fi'
            {
            match("fi"); 
    ...
    public final void mT__34() throws RecognitionException {
        try {
            int _type = T__34;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:30:7: ( 'nop' )
            // InternalMyDsl.g:30:9: 'nop'
            {
            match("nop"); 
    ...
    public final void mRULE_SEP() throws RecognitionException {
        try {
            int _type = RULE_SEP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:4078:10: ( ';' )
            // InternalMyDsl.g:4078:12: ';'
            {
            match(';'); 
    ...
    public final void mRULE_MAJ() throws RecognitionException {
        try {
            int _type = RULE_MAJ;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:4080:10: ( 'A' .. 'Z' ( 'A' .. 'Z' | 'a' .. 'z' )* )
            // InternalMyDsl.g:4080:12: 'A' .. 'Z' ( 'A' .. 'Z' | 'a' .. 'z' )*
            {
            matchRange('A','Z'); 
            // InternalMyDsl.g:4080:21: ( 'A' .. 'Z' | 'a' .. 'z' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_SYMBOL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:4082:13: ( 'a' .. 'z' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )* ( ( ( '-' | '+' | '.' | '/' | '_' | '&' ) | '->' ) ( '0' .. '9' | 'a' .. 'z' | 'A' .. 'Z' )+ )* ( '?' | '!' )? )
            // InternalMyDsl.g:4082:15: 'a' .. 'z' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )* ( ( ( '-' | '+' | '.' | '/' | '_' | '&' ) | '->' ) ( '0' .. '9' | 'a' .. 'z' | 'A' .. 'Z' )+ )* ( '?' | '!' )?
            {
            matchRange('a','z'); 
            // InternalMyDsl.g:4082:24: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
            ...
            // InternalMyDsl.g:4082:54: ( ( ( '-' | '+' | '.' | '/' | '_' | '&' ) | '->' ) ( '0' .. '9' | 'a' .. 'z' | 'A' .. 'Z' )+ )*
            loop5:
            do {
                int alt5=2;
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalMyDsl.g:4082:55: ( ( '-' | '+' | '.' | '/' | '_' | '&' ) | '->' ) ( '0' .. '9' | 'a' .. 'z' | 'A' .. 'Z' )+
            	    {
            	    // InternalMyDsl.g:4082:55: ( ( '-' | '+' | '.' | '/' | '_' | '&' ) | '->' )
            	    int alt3=2;
            	    ...
            	    // InternalMyDsl.g:4082:88: ( '0' .. '9' | 'a' .. 'z' | 'A' .. 'Z' )+
            	    int cnt4=0;
            	    loop4:
            	    do {
            	        int alt4=2;
    ...
    public final void mRULE_ESPACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:4084:13: ( '\\n' )
            // InternalMyDsl.g:4084:15: '\\n'
            {
            match('\n'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:4086:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalMyDsl.g:4086:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalMyDsl.g:4086:11: ( '^' )?
            int alt7=2;
            ...
            // InternalMyDsl.g:4086:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:4088:10: ( ( '0' .. '9' )+ )
            // InternalMyDsl.g:4088:12: ( '0' .. '9' )+
            {
            // InternalMyDsl.g:4088:12: ( '0' .. '9' )+
            int cnt9=0;
            loop9:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:4090:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalMyDsl.g:4090:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalMyDsl.g:4090:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // InternalMyDsl.g:4090:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalMyDsl.g:4090:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop10:
                    do {
                        int alt10=3;
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:4090:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalMyDsl.g:4090:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop11:
                    do {
                        int alt11=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:4092:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalMyDsl.g:4092:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalMyDsl.g:4092:24: ( options {greedy=false; } : . )*
            loop13:
            do {
                int alt13=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:4094:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalMyDsl.g:4094:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalMyDsl.g:4094:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop14:
            do {
                int alt14=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:4096:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalMyDsl.g:4096:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalMyDsl.g:4096:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt17=0;
            loop17:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:4098:16: ( . )
            // InternalMyDsl.g:4098:18: .
            {
            matchAny(); 
    ...
    static final String DFA18_eotS =
        "\1\uffff\1\43\1\47\1\43\1\uffff\1\43\1\uffff\5\43\2\uffff\4\43\1\37\1\43\1\uffff\1\77\1\43\1\102\1\37\2\uffff\3\37\2\uffff\1\43\1\111\1\43\1\uffff\1\43\1\101\2\uffff\1\43\1\uffff\2\43\1\uffff\1\117\1\120\1\43\1\122\1\43\1\124\1\125\1\126\2\uffff\2\43\1\132\2\43\1\uffff\1\43\2\uffff\1\77\7\uffff\1\43\1\uffff\1\140\4\43\2\uffff\1\43\1\uffff\1\43\3\uffff\1\146\1\147\1\150\1\uffff\2\43\1\153\2\43\1\uffff\1\156\2\43\1\161\1\162\3\uffff\1\163\1\164\1\uffff\2\43\1\uffff\1\167\1\170\4\uffff\2\43\2\uffff\1\43\1\174\1\175\2\uffff";
