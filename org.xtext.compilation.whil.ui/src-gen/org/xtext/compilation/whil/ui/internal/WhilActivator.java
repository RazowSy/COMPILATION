 ...
 */
package org.xtext.compilation.whil.ui.internal;
 ...
 * introduced subclass. 
 */
public class WhilActivator extends AbstractUIPlugin {

	public static final String ORG_XTEXT_EXAMPLE_MYDSL_MYDSL = "org.xtext.example.mydsl.MyDsl";
	
	private static final Logger logger = Logger.getLogger(WhilActivator.class);
	
	private static WhilActivator INSTANCE;
	...
	public static WhilActivator getInstance() {
		return INSTANCE;
	}
